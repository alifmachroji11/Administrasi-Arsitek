  ...
  return (
    <>
      <div className="my-4 flex items-center gap-3">
        <span className="h-px flex-1" style={{ background: "var(--color-stone-line)" }} />
        <span className="text-[11.5px] font-medium" style={{ color: "var(--color-ink-faint)" }}>
          atau
        </span>
        <span className="h-px flex-1" style={{ background: "var(--color-stone-line)" }} />
      </div>
      <button
        ...
        className="flex w-full items-center justify-center gap-2.5 rounded-xl border py-3 text-[14px] font-medium"
